...
def get_split_evaluations(evaluations: list[Evaluation]) -> list[ExtEvaluation]:
    ...
    for evaluation in evaluations:
        split_evaluations.append(ExtEvaluation(evaluation, True))
        split_evaluations.append(ExtEvaluation(evaluation, False))
    return split_evaluations

(evaluations: list[Evaluation], iteration_dir: Path, eval_runner: EvaluationRunner) -> list[Evaluation]:
